...
void MinMaxArray(int[] array)       // Метод нахождение разницы между максимальным и минимальным элементами матрицы (ЗАДАЧА 38)
{
    ...
    Console.WriteLine($"Максимальный элемент массива {elem_max} и минимальный элемент массива {elem_min}");
    Console.WriteLine($"Разница между максимальным и минимальным элементами массива: {elem_max - elem_min}");
}
